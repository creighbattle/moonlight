...
// export function signUp(email, password, passwordConfirmation, name, navigation) {
...
//         docRef.get().then((doc) => {
//           const name = doc.data().memberName
...
//   global.counter = true;
//   global.signout = false;
// }

// export function test(nav) {
//   () => nav();
// }